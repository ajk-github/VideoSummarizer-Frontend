...
export default function Navbar() {
    ...
    const unsubscribe = onAuthStateChanged(auth, async (firebaseUser) => {
      ...
      if (firebaseUser) {
        try {
          ...
          sessionStorage.setItem('was_logged_in_before', 'true');
        ...
        const wasLoggedIn = sessionStorage.getItem('was_logged_in_before') === 'true';
        if (wasLoggedIn) handleSessionExpiry();
        setUser(null);
      }
    });
  ...
  return (
    <>
      ...
      {firebaseInitialized && showExpiredDialog && (
